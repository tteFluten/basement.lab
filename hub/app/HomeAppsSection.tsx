...
import { Film, Clock, Shirt, UserCircle, ImagePlus, Layers, ArrowRight, Plus, Banana, ListChecks } from "lucide-react";
...
const TOOL_APPS = [
  { slug: "feedback", label: "Feedback", desc: "Video annotation and timestamped feedback", Icon: ListChecks, span: "col-span-2 row-span-1", cover: null },
];
