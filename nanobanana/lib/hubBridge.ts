 ...
 * When running inside Hub iframe, parent handles modals and history.
 */
...
/** Open Hub modal: upload file or pick from history. Resolves with dataUrl. */
...
/** Open Hub modal: download and add to history. Resolves when done. */
