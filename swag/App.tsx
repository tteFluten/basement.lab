    ...
    <div className="min-h-screen bg-[var(--app-bg)] text-zinc-400 font-mono">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 grid lg:grid-cols-12 gap-12">
        ...
        <aside className="lg:col-span-4 space-y-10">
          ...
          <section className="space-y-4">
            <h2 className="text-[10px] font-bold text-zinc-600 uppercase tracking-[0.2em]">02_Style_Reference</h2>
            <div className="space-y-4">
              <select 
                value={stylePreset} 
              ...
              >
                {styleRef ? (
                  ...
                  <div className="text-center p-4">
                    <p className="text-[10px] text-zinc-600 uppercase tracking-tighter">{isHubEnv() ? 'Upload_Or_From_History' : 'Upload_Reference'}</p>
                  </div>
                )}
          ...
          <section className="space-y-4">
            <h2 className="text-[10px] font-bold text-zinc-600 uppercase tracking-[0.2em]">04_Custom_Directives</h2>
            <textarea
