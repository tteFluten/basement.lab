    ...
    <div className="min-h-screen bg-black text-slate-400 font-mono">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 grid lg:grid-cols-12 gap-12">
        ...
        <aside className="lg:col-span-4 space-y-10">
          ...
          <section className="space-y-4">
            <h2 className="text-[10px] font-bold text-slate-600 uppercase tracking-[0.2em]">02_Style_Control</h2>
            <div className="space-y-4">
              <select 
                value={stylePreset} 
              ...
              >
                {styleRef ? (
                  ...
                  <div className="text-center p-4">
                    <p className="text-[10px] text-slate-600 uppercase tracking-tighter">Style_Reference</p>
                  </div>
                )}
                  ...
                  <div key={item.id} className="group border border-slate-800 bg-black overflow-hidden relative transition-all hover:border-slate-500">
                    ...
                    <div className="p-4 flex items-center justify-between border-t border-slate-800 bg-black">
                      <div className="space-y-1">
                        <p className="text-[10px] font-bold text-slate-200 uppercase tracking-tighter">{item.config.mockup}</p>
